...
from myobject.settings import EMAIL_FROM
...
def send_register_email(email,send_type='register'):
    ...
    if send_type == 'register':
        ...
        email_body = '请点击下面的链接重设你的密码：http://127.0.0.1:8000/resetpwd/{0}'.format(code)
